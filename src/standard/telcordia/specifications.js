...
exports.TelcordiaMiscellaneousPowerModuleSpecifications = exports.TelcordiaMiscellaneousLampIncandescentSpecifications = exports.TelcordiaMiscellaneousFuseSpecifications = exports.TelcordiaMiscellaneousCircuitBreakerSpecifications = exports.TelcordiaMiscellaneousVibratorSpecifications = exports.TelcordiaTransistorSpecifications = exports.TelcordiaSwitchSpecification = exports.TelcordiaResisotrNetworkSpecification = exports.TelcordiaVariableResistorSpecifications = exports.TelcordiaFixedResistorSpecifications = exports.TelcordiaRelaySpecifications = exports.TelcordiaOptoElectronicTransceiverSFPSpecification = exports.TelcordiaOptoElectronicPumpLaserSpecification = exports.TelcordiaMicrowaveSpecifications = exports.TelcordiaMicroprocessorSpecifications = exports.TelcordiaROMICSpecifications = exports.TelcordiaRAMICSpecifications = exports.TelcordiaDigitalICSpecifications = exports.TelcordiaAnalogICSpecifications = exports.TelcordiaICTechnologySpecification = exports.TelcordiaDiodeSpecifications = exports.TelcordiaConnectorSpecifications = exports.TelcordiaCapacitorSpecification = exports.TelcordiaElecStressPercentageManualSpecification = exports.TelcordiaPackagingSpecification = exports.TelcordiaBasicSpecifications = void 0;
const sr332_1 = require("./sr332");
exports.TelcordiaBasicSpecifications = [
    {
    ...
    },
    {
        ...
        type: 'options',
        initialValue: sr332_1.TelcordiaQualityFactor.LEVEL_2,
        options: [
            {
                label: "Level 0",
                value: sr332_1.TelcordiaQualityFactor.LEVEL_0,
            },
            {
                label: "Level 1",
                value: sr332_1.TelcordiaQualityFactor.LEVEL_1,
            },
            {
                label: "Level 2",
                value: sr332_1.TelcordiaQualityFactor.LEVEL_2,
            },
            {
                label: "Level 3",
                value: sr332_1.TelcordiaQualityFactor.LEVEL_3,
            },
        ]
    },
    {
...
exports.TelcordiaPackagingSpecification = {
...
exports.TelcordiaElecStressPercentageManualSpecification = {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
exports.TelcordiaCapacitorSpecification = [
    {
...
exports.TelcordiaConnectorSpecifications = [
    {
...
exports.TelcordiaDiodeSpecifications = [
    {
...
exports.TelcordiaICTechnologySpecification = {
...
exports.TelcordiaAnalogICSpecifications = [
    exports.TelcordiaICTechnologySpecification,
    {
...
exports.TelcordiaDigitalICSpecifications = [
    exports.TelcordiaICTechnologySpecification,
    {
...
exports.TelcordiaRAMICSpecifications = [
    exports.TelcordiaICTechnologySpecification,
    {
...
exports.TelcordiaROMICSpecifications = [
    exports.TelcordiaICTechnologySpecification,
    {
...
exports.TelcordiaMicroprocessorSpecifications = [
    exports.TelcordiaICTechnologySpecification,
    {
...
exports.TelcordiaMicrowaveSpecifications = [
    {
        id: "SPEC-DEVICE-006-001",
        name: "정격 전압",
        key: "ratedVoltage",
        description: "마이크로파 반도체 소자의 정격 전력입니다. 장치가 안전하게 처리할 수 있는 최대 마이크로파 전력을 나타냅니다.",
        engName: "Rated Voltage",
        type: 'scalar',
        initialValue: 0,
        unit: "W"
...
exports.TelcordiaOptoElectronicPumpLaserSpecification = [
    {
...
exports.TelcordiaOptoElectronicTransceiverSFPSpecification = [
    {
...
exports.TelcordiaRelaySpecifications = [
    {
...
exports.TelcordiaFixedResistorSpecifications = [
    {
...
exports.TelcordiaVariableResistorSpecifications = [
    {
...
exports.TelcordiaResisotrNetworkSpecification = [
    {
...
exports.TelcordiaSwitchSpecification = [
    {
...
exports.TelcordiaTransistorSpecifications = [
    {
    ...
    },
    {
        ...
        name: "정격 전력",
        key: "ratedPower",
        description: "트랜지스터가 안전하게 처리할 수 있는 최대 전력입니다. 제조사가 보증하는 허용 전력으로, 이를 초과하면 트랜지스터가 과열되어 손상됩니다.",
        engName: "Rated Power",
        type: 'scalar',
        initialValue: 0,
        unit: "W"
...
exports.TelcordiaMiscellaneousVibratorSpecifications = [
    {
...
exports.TelcordiaMiscellaneousCircuitBreakerSpecifications = [
    {
...
exports.TelcordiaMiscellaneousFuseSpecifications = [
    {
...
exports.TelcordiaMiscellaneousLampIncandescentSpecifications = [
    {
...
exports.TelcordiaMiscellaneousPowerModuleSpecifications = [
    {
