...
class TelcordiaDevice extends common_1.ElectronicDevice {
    ...
    alias;
    category;
    specifications; // for Category Specification
    integratingLaboratoryData; // for Method - II
    integratingFieldData; // for Method - III
    burnInTime; // for Early-Life Factor, Method - II, Method- III
...
class TelcordiaPredictionCtx extends common_1.PredictionCtx {
    method;
    appliedUCL = false;
    appliedEarlyLife = false;
    confidenceLevel; // for UCL Calculation
    constructor() {
        super();
        this.method = "METHOD_I";
    }
    createDevice = (category, unitId) => {
